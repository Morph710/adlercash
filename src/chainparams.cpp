...
static Checkpoints::MapCheckpoints mapCheckpoints =
	...
	(0, uint256("0x00000fae3d57d3c037ce9445adff7b3de4acdaf330274013271fff5a3eacb871"));

static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1528963618, // * UNIX timestamp of last checkpoint block
...
public:
	...
	nMaxMoneyOut = 10000000000 * COIN;
        ...
        nZerocoinStartTime = 1528964617; // Saturday, 04-Aug-18 00:00:00 UTC
	nZerocoinStartHeight = 129601;
		
	const char* pszTimestamp = "what goes around comes around";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1528963618;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 2585293;
        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x00000fae3d57d3c037ce9445adff7b3de4acdaf330274013271fff5a3eacb871"));
        assert(genesis.hashMerkleRoot == uint256("0x0a67295c87ac87b83bf9b6fd6d20c7248e5d88fd4221bdcf742b561ea7c5d87c"));

	vFixedSeeds.clear();
        vSeeds.clear();
		
        vSeeds.push_back(CDNSSeedData("0", "45.77.97.88"));
        vSeeds.push_back(CDNSSeedData("1", "149.28.32.27"));
        vSeeds.push_back(CDNSSeedData("2", "217.69.0.52"));
        vSeeds.push_back(CDNSSeedData("3", "108.61.208.127"));
	...
	strSporkKey = "033d9905c6efff2f7ab385bc7ac4dc8651d548f7200f07663afd284e80dea99fbc";
        ...
        strObfuscationPoolDummyAddress = "Ag3aLcSeLqbpEsVgoXtDFrpDYDfAsf1qxv";

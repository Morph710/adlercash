...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop AdlerCash server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "AdlerCash server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* AdlerCash features */
        {"AdlerCash", "masternode", &masternode, true, true, false},
        {"AdlerCash", "listmasternodes", &listmasternodes, true, true, false},
        {"AdlerCash", "getmasternodecount", &getmasternodecount, true, true, false},
        {"AdlerCash", "masternodeconnect", &masternodeconnect, true, true, false},
        {"AdlerCash", "masternodecurrent", &masternodecurrent, true, true, false},
        {"AdlerCash", "masternodedebug", &masternodedebug, true, true, false},
        {"AdlerCash", "startmasternode", &startmasternode, true, true, false},
        {"AdlerCash", "createmasternodekey", &createmasternodekey, true, true, false},
        {"AdlerCash", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"AdlerCash", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"AdlerCash", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"AdlerCash", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"AdlerCash", "getmasternodescores", &getmasternodescores, true, true, false},
        {"AdlerCash", "mnbudget", &mnbudget, true, true, false},
        {"AdlerCash", "preparebudget", &preparebudget, true, true, false},
        {"AdlerCash", "submitbudget", &submitbudget, true, true, false},
        {"AdlerCash", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"AdlerCash", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"AdlerCash", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"AdlerCash", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"AdlerCash", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"AdlerCash", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"AdlerCash", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"AdlerCash", "checkbudgets", &checkbudgets, true, true, false},
        {"AdlerCash", "mnsync", &mnsync, true, true, false},
        {"AdlerCash", "spork", &spork, true, true, false},
        {"AdlerCash", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"AdlerCash", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use AdlerCashd, or the -server option to AdlerCash-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> AdlerCash-cli " + methodname + " " + args + "\n";
}

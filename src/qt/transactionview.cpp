                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received ADL from zADL"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zADL"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zADL));
...
void TransactionView::setModel(WalletModel* model)
{
    ...
    if (model) {
        ...
        transactionView->setColumnWidth(TransactionTableModel::Watchonly, WATCHADLY_COLUMN_WIDTH);

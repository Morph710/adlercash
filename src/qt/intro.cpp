...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("AdlerCash Core"),
     ...
     * override -datadir in the AdlerCash.conf file in the default data directory
     * (to be consistent with AdlerCashd behavior)
     */
    if (dataDir != getDefaultDataDirectory())

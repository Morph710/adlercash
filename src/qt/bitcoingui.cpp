                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("AdlerCash Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a AdlerCash address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and AdlerCash URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zADL"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About AdlerCash Core"), this);
    aboutAction->setStatusTip(tr("Show information about AdlerCash Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for AdlerCash"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your AdlerCash addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified AdlerCash addresses"));
    ...
    openAction->setStatusTip(tr("Open a AdlerCash URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the AdlerCash Core help message to get a list with possible AdlerCash command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("AdlerCash Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to AdlerCash network", "", count));
}
...
void BitcoinGUI::setNumBlocks(int count)
{
    ...
    case BLOCK_SOURCE_NETWORK:
        progressBarLabel->setText(tr("Synchronizing with AdlerCash network..."));
        break;
...
{
    QString strTitle = tr("AdlerCash Core"); // default title

...
void RPCConsole::walletResync()
{
    ...
    QMessageBox::StandardButton retval = QMessageBox::question(this, tr("Confirm resync AdlerCash Blockchain"),
        resyncWarning,
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the AdlerCash RPC console.") + "<br>" +

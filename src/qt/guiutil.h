...
/** Utility functions used by the AdlerCash Qt UI.
 */
namespace GUIUtil
{
...
// Render AdlerCash addresses in monospace font
...
// Parse "AdlerCash:" URI into recipient object, return true on successful parsing

...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("AdlerCash Core AdlerCash-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  AdlerCash-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded AdlerCash transaction") + "\n" +
                               "  AdlerCash-tx [options] -create [commands]   " + _("Create hex-encoded AdlerCash transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded AdlerCash transaction

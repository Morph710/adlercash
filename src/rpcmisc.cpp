...
Value getinfo(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"balance\": xxxxxxx,         (numeric) the total AdlerCash balance of the wallet (excluding zerocoins)\n"
            ...
            "  \"zADLsupply\" :\n"
            "  {\n"
            "     \"1\" : n,            (numeric) supply of 1 zADL denomination\n"
            "     \"5\" : n,            (numeric) supply of 5 zADL denomination\n"
            "     \"10\" : n,           (numeric) supply of 10 zADL denomination\n"
            "     \"50\" : n,           (numeric) supply of 50 zADL denomination\n"
            "     \"100\" : n,          (numeric) supply of 100 zADL denomination\n"
            "     \"500\" : n,          (numeric) supply of 500 zADL denomination\n"
            "     \"1000\" : n,         (numeric) supply of 1000 zADL denomination\n"
            "     \"5000\" : n,         (numeric) supply of 5000 zADL denomination\n"
            "     \"total\" : n,        (numeric) The total supply of all zADL denominations\n"
            "  }\n"
            "  \"keypoololdest\": xxxxxx,    (numeric) the timestamp (seconds since GMT epoch) of the oldest pre-generated key in the key pool\n"
            "  \"keypoolsize\": xxxx,        (numeric) how many new keys are pre-generated\n"
            "  \"unlocked_until\": ttt,      (numeric) the timestamp in seconds since epoch (midnight Jan 1 1970 GMT) that the wallet is unlocked for transfers, or 0 if the wallet is locked\n"
            "  \"paytxfee\": x.xxxx,         (numeric) the transaction fee set in AdlerCash/kb\n"
            "  \"relayfee\": x.xxxx,         (numeric) minimum relay fee for non-free transactions in AdlerCash/kb\n"
    ...
    obj.emplace_back(Pair("zADLsupply", zonlObj));
...
Value validateaddress(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "validateaddress \"AdlerCashaddress\"\n"
            "\nReturn information about the given AdlerCash address.\n"
            "\nArguments:\n"
            "1. \"AdlerCashaddress\"     (string, required) The AdlerCash address to validate\n"
            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,         (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"AdlerCashaddress\", (string) The AdlerCash address validated\n"
    ...
    if (isValid) {
        ...
        if (mine != ISMINE_NO) {
            ret.push_back(Pair("iswatchonly", (mine & ISMINE_WATCH_ADLY) ? true : false));
...
#ifdef ENABLE_WALLET
        // Case 1: AdlerCash address and we have full public key:
...
Value createmultisig(const Array& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 2) {
        string msg = "createmultisig nrequired [\"key\",...]\n"
                     ...
                     "2. \"keys\"       (string, required) A json array of keys which are AdlerCash addresses or hex-encoded public keys\n"
                     "     [\n"
                     "       \"key\"    (string) AdlerCash address or hex-encoded public key\n"
                     "       ,...\n"
                     "     ]\n"
...
Value verifymessage(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            "verifymessage \"AdlerCashaddress\" \"signature\" \"message\"\n"
            "\nVerify a signed message\n"
            "\nArguments:\n"
            "1. \"AdlerCashaddress\"  (string, required) The AdlerCash address to use for the signature.\n"

Contributing to AdlerCash Core
============================

The AdlerCash Core project operates an open contributor model where anyone is
...
The following applies to code changes to the AdlerCash Core project, and is not to be
confused with overall AdlerCash Network Protocol consensus changes.

Whether a pull request is merged into AdlerCash Core rests with the project merge
...
Patches that change AdlerCash consensus rules are considerably more involved than
...
Where a patch set proposes to change the AdlerCash consensus, it must have been
...
The project leader is the release manager for each AdlerCash Core release.

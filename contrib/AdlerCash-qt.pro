...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/AdlerCash-cli.cpp \
           src/AdlerCash-tx.cpp \
           src/AdlerCash.cpp \
           src/db.cpp \
           ...
           src/qt/AdlerCash.cpp \
           src/qt/AdlerCashstrings.cpp \
...
RESOURCES += src/qt/AdlerCash.qrc src/qt/AdlerCash_locale.qrc

TRANSLATIONS += src/qt/locale/AdlerCash_bg.ts \
                src/qt/locale/AdlerCash_de.ts \
                src/qt/locale/AdlerCash_en.ts \
                src/qt/locale/AdlerCash_es.ts \
                src/qt/locale/AdlerCash_fi.ts \
                src/qt/locale/AdlerCash_fr.ts \
                src/qt/locale/AdlerCash_it.ts \
                src/qt/locale/AdlerCash_ja.ts \
                src/qt/locale/AdlerCash_pl.ts \
                src/qt/locale/AdlerCash_pt.ts \
                src/qt/locale/AdlerCash_ru.ts \
                src/qt/locale/AdlerCash_sk.ts \
                src/qt/locale/AdlerCash_sv.ts \
                src/qt/locale/AdlerCash_vi.ts \
                src/qt/locale/AdlerCash_zh_CN.ts \
                src/qt/locale/AdlerCash_zh_TW.ts

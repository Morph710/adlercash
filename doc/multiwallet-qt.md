...
In order to support loading of multiple wallets in AdlerCash-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is AdlerCash.cpp.
...
Changes to AdlerCash.cpp
----------------------
AdlerCash.cpp is the entry point into AdlerCash-qt, and as such, will require some minor modifications to provide hooks for
